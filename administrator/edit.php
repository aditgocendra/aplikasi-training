...
if ($_GET[rubah] == "masterUser") {
    ...
    $query = mysql_query("UPDATE  `tugas_akhir_12101020`.`m_jadwal` SET `start_date` =  '$_POST[startdate]', `nama_paket` =  '$_POST[nama_paket]', `end_date` =  '$_POST[enddate]' WHERE  `m_jadwal`.`id_jadwal` =$_POST[id]");
    if ($query) {
        echo"
            <script type=\"text/javascript\">
                alert(\"Data berhasil dirubah.\")
