...
switch ($_GET[link]) {
    ...
    if ($_POST[nama_peserta] != null && $_POST[nama_paket] != null && $_POST[harga] != null) {
        ...
        $query = mysql_query("INSERT INTO `tugas_akhir_12101020`.`daftar_training` (`id_daftar_training`, `nama_peserta`, `nama_paket`, `harga`, `status`) VALUES (NULL, '$isi[nama_lengkap]', '$_POST[nama_paket]', '$_POST[harga]', 'BELUM_LUNAS')");
        if ($query) {
            echo"
